...
public class ShmineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shmine);
...
//        initView();
    ...
    private void initView(List<Map<String, Object>> lists) {
        ...
        adapter = new MyAdapter(lists,ShmineActivity.this);
        listView.post(new Runnable() {
            @Override
            public void run() {
                listView.setAdapter(adapter);

                listView.setEmptyView(findViewById(R.id.content_tv));
            }
        });
...
//        });
    ...
    private void get(){
        new Thread(() -> {
            ...
            // url路径
            String url = "http://47.107.52.7:88/member/photo/share/myself?userId=" +
                    userid;
