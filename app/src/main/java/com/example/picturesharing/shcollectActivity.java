...
public class shcollectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shcollect);
...
//        initView();
    ...
    private void initView(List<Map<String, Object>> lists) {
        ...
        adapter = new MyAdapter(lists,shcollectActivity.this);
    ...
    private void get(){
        new Thread(() -> {
            ...
            // url路径
            String url = "http://47.107.52.7:88/member/photo/collect?userId=" +
                    userid;
    ...
    private final Callback callback = new Callback() {
        ...
        public void onResponse(@NonNull Call call, Response response) throws IOException {
            //TODO 请求成功处理
            Type jsonType = new TypeToken<ShlikeActivity.ResponseBody<Object>>(){}.getType();
            // 获取响应体的json串
            String body = response.body().string();
            Log.d("info", body);
            // 解析json串到自己封装的状态
            ShlikeActivity.ResponseBody<Object> dataResponseBody = gson.fromJson(body,jsonType);
            ...
            if(dataResponseBody.getData()==null){
                startActivity(new Intent(shcollectActivity.this,NoThingActivity.class));
            }else {
